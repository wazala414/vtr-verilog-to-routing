...
with open(out_arch_name, "w") as out_arch:
    ...
    # Input Case List:
    #       - Predefined SB
    #           - Replace <switchblock type="".../> by <switchblock name="" type="custom"/>
    #           - Add <switchblocklist>
    #           - Add <switchfuncs>
    #           - Add wireconn according to previous predefined topology
    #       - Custom SB
    #           - Replace content of <switchfuncs>
    #           - Keep the rest the same
    # Output Case List:
    #       - Unidir FS4 same side
    #           - Add ll,tt,bb,rr in <switchfuncs>
    #       - Unidir Full
    #           - Replace <switchfuncs> according to routing width
    #       - Unidir Full same side
    #           - Replace <switchfuncs> according to routing width
    #
    #       
    #       - Both FULL can be done at the same time but cases should be made to avoid same side in one of the cases