...
def netlist_parse(route_in, regex_out, route_out):
    # Initialization
    regex_list = list()
    x = 0
    y = 0
    ...
    with open(route_in, "r") as route_file:
    ...
    if regex_out:
        sb_regex_df.to_csv(regex_out+"_SB")
        cb_regex_df.to_csv(regex_out+"_CB")
    ...
    sb_df.to_csv(route_out)

netlist_parse(args.route_in, args.regex_out, args.route_out)
